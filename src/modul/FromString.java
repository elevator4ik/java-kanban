...
public class FromString {//преобразование тасков из строк фала вынесено в отдельный класс
    public Task taskFromString(String[] newTask) {
    ...
    public SubTask subTaskFromString( String[] newTask) {
    ...
    public Epic epicFromString( String[] newTask) {//возвращает те же поля, что и таск, но важно чтобы это был эпик
