...
class InMemoryHistoryManagerTest {
    ...
    void addInVoidList_GetHistoryTest_AddToNotEmptyListAndRemoveDoublicate() {//Проверяем сразу добавление в пустой
        ...
        assertEquals("[0,Testing addTask,NEW,Test addTask description,10,2023-01-01T23:00,2023-01-01T23:10,\n" +
                        "]",
    ...
    void removeFromBegin_Middle_EndOfList() {
        ...
        assertEquals("[1,Test addSubTask,NEW,Test addSubTask description,10,2023-01-01T22:15,2023-01-01T22:25,20,\n" +
                        ", 2,Testing addTask,NEW,Test addTask description,10,2023-01-01T23:00,2023-01-01T23:10,\n" +
                        ", 3,Testing addSubTask,NEW,Test addSubTask description,10,2023-01-01T22:30,2023-01-01T22:40,20,\n" +
                        "]",
